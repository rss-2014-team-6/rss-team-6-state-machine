...
public class SonarGUI extends VisionGUI {
	...
	public void onStart(ConnectedNode node) {
		super.onStart(node);
		guiLineSub = node.newSubscriber("gui/Line", "gui_msgs/GUILineMsg");
		guiSegmentSub = node.newSubscriber("gui/Segment", "gui_msgs/GUISegmentMsg");
		guiPointSub = node.newSubscriber("gui/Point", "gui_msgs/GUIPointMsg");
